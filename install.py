...
def parse_commandline_args():
	...
	parser.add_argument('--frappe-branch', dest='frappe_branch', action='store', default='version-13', help='Clone a particular branch of frappe')
	...
	parser.add_argument('--erpnext-branch', dest='erpnext_branch', default='version-13', action='store', help='Clone a particular branch of erpnext')
